...
read -p "Enter passwd for encryption: " passw_crypt
...
printf "n\n1\n\n+666M\nef00\nn\n2\n\n\n\nw\ny\n" | gdisk /dev/nvme0n1
echo "$passwd_crypt" | cryptsetup luksFormat /dev/nvme0n1p2
echo "$passwd_crypt" | cryptsetup luksOpen /dev/nvme0n1p2 luks
